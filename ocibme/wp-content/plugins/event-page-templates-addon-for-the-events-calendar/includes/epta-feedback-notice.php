   ...
   // admin notice  
    public function epta_admin_notice_for_reviews(){
        ...
        if (isset($diff_days) && $diff_days>=3) {
                echo $this->epta_create_notice_content();
                }
       }  
       ...
       function epta_create_notice_content(){
        ...
        <ul>
            ...
            <li class="already_rated"><a href="javascript:void(0);" class="already_rated_btn button tecset_dismiss_notice" title="%7$s">%7$s</a></li> 
            <li class="already_rated"><a href="javascript:void(0);" class="already_rated_btn button tecset_dismiss_notice" title="%11$s">%11$s</a></li>                       
        </ul>
