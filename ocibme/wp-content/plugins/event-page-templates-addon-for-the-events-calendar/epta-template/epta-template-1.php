...
<div id="epta-template" class="epta-row epta-<?php echo $get_temp_cls;?>">
    <div class="epta-all-events col-md-12">
        <a href="<?php echo $tecset_all_events ?>"><< <?php echo __('All Events', 'epta');?></a>
    </div>
    <div class="col-md-8">
          ...
          if(function_exists('tribe_get_custom_fields')){
           ...
           if(is_array($additional_fields )){
               foreach($additional_fields  as $key=>$field){
                   echo '<div class="epta-additional-content">'.$field.'</div>';
               }
           }
        }
    ...
    <div class="col-md-4">
        <div class="epta-sidebar-area">
            ...
            if( $seconds > 0 ){	?>
                    ...
                    ?>
                    <div class="epta-countdown-timer">
                        <span class="epta-countdown-seconds"><?php echo $seconds; ?></span>
                        <span class="epta-countdown-format"><?php echo $hourformat ?></span>
                    </div>
            ...
            <div class="epta-sidebar-box">
                <div class="epta-addto-calendar">
                    <?php
                    echo '<a href="' . \Tribe__Events__Main::instance()->esc_gcal_url( tribe_get_gcal_link() ) . '" title="' . esc_attr__( 'Add to Google Calendar', 'the-events-calendar' ) . '">+ ' . esc_html__( 'Google Calendar', 'the-events-calendar' ) . '</a>';
    ...
    <div class="col-md-12">
        ...
        if ( is_array( $posts ) && ! empty( $posts ) ) : ?>
            <div class="epta-related-area">
                <h3 class="epta-related-head"><?php echo __('Related Events', 'epta');?></h3>
                <div class="epta-row">
                    ...
                    <div class="col-sm-4">
                        <div class="epta-related-box">
                            ...
                            <div class="epta-related-title <?php if(tribe_event_featured_image($post->ID, 'full', false)==''){echo "no-image";} ?>">
                                <h4><a href="<?php echo tribe_get_event_link( $post );?>"><?php echo esc_html(get_the_title( $post->ID )); ?></a></h4>
                                <div class="epta-related-date"><?php echo tribe_events_event_schedule_details($post->ID); ?></div>
                                <div class="epta-light-bg"></div>
                            </div>
                        </div>
                    </div>
