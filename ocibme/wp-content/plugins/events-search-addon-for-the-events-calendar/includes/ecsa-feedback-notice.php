...
if (!class_exists('ecsaFeedbackNotice')) {
    class ecsaFeedbackNotice {
        ...
        public function __construct() {
            ...
            if(is_admin()){
                ...
                add_action( 'admin_print_scripts', array($this, 'ecsa_load_script' ) );
	 ...
	 * @return void
	 */
	public function ecsa_load_script() {
		wp_register_script( 'ecsa-feedback-notice-script', ECSA_URL. 'assets/js/ecsa-admin-feedback-notice.js', array( 'jquery' ),null, true );
        wp_enqueue_script( 'ecsa-feedback-notice-script' );
        wp_register_style( 'ecsa-feedback-notice-styles',ECSA_URL.'assets/css/ecsa-admin-feedback-notice.css' );
        wp_enqueue_style( 'ecsa-feedback-notice-styles' );
    }
   ...
   // admin notice  
    public function ecsa_admin_notice_for_reviews(){
       ...
       function create_notice_content(){
        ...
        $img_path=ECSA_URL.'assets/images/ecsa-logo.png';
        ...
        <ul>
            ...
            <li class="already_rated"><a href="javascript:void(0);" class="already_rated_btn button ecsa_dismiss_notice" title="%7$s">%7$s</a></li>            
        </ul>
