=== Events Shortcodes & Templates Addon For The Events Calendar ===
...
The Events Calendar shortcodes & templates addon provides event shortcode builder & Gutenberg blocks to show events list in any page/post.

== Description ==

### 📅 Events Shortcodes & Templates For The Events Calendar

Best addon for **The Events Calendar** plugin (free version by Modern Tribe) to show your events anywhere inside your page or post using **events shortcode builder** or Gutenberg blocks. This **events calendar addon** also provides free stunning events list design templates in which you can select custom colors and fonts.

> The Events Calendar plugin has **800,000+ active users**. You can extend this famous free plugin features by using this **Events Shortcodes and Templates** addon that provides events template design and shortcode options.
